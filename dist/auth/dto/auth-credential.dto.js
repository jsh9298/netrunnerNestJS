...
], AuthCredentialsDto.prototype, "userId", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(4),
    (0, class_validator_1.MaxLength)(20),
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(20),
    (0, class_validator_1.Matches)(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}$/, { message: 'Incorrect Password Type' }),
    __metadata("design:type", String)
], AuthCredentialsDto.prototype, "password", void 0);
__decorate([
    (0, class_validator_1.IsEmail)(),
    (0, class_validator_1.Matches)(/^[^\s@]+@[^\s@]+\.[^\s@]+$/, { message: 'Incorrect Email Form' }),
    __metadata("design:type", String)
